...
use aptos_types::{
    ...
    account_config::{
        ...
        AptosAccountResource, RoleId, XDX_NAME, XUS_NAME,
    },
    chain_id::ChainId,
    event::EventHandle,
    transaction::{
...
impl Account {
    ...
    pub fn make_account_access_path(&self) -> AccessPath {
        self.make_access_path(AptosAccountResource::struct_tag())
    }
...
impl AccountData {
    ...
    /// Returns the (Move value) layout of the AptosAccount::AptosAccount struct
    pub fn layout() -> MoveStructLayout {
