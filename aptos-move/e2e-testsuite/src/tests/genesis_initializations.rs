...
#[test]
fn test_aptos_timestamp_time_has_started() {
    let mut executor = FakeExecutor::stdlib_only_genesis();
    let account_address = AccountAddress::random();

    // Invalid address used to call `AptosTimestamp::set_time_has_started`
    let output = executor.try_exec(
        "AptosTimestamp",
...
#[test]
fn test_aptos_block_double_init() {
    let mut executor = FakeExecutor::stdlib_only_genesis();
