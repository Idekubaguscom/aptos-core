...
custom_edit_url: https://github.com/aptos/aptos/edit/main/language/move-binary-format/vm-runtime/README.md
---
...
account](../diem-framework/modules/aptos_account.mvir)---specifically the transaction
...
1. ***Transaction Prologue*** - in verification mode the runtime runs the
   ...
   module](../diem-framework/modules/aptos_account.mvir). The prologue is responsible
...
3. ***Transaction Epilogue*** - in execution mode the epilogue defined in
   the [Aptos account module](../diem-framework/modules/aptos_account.mvir) is
...
* The runtime top level structs are in `runtime` and `aptos vm` related
  code.
