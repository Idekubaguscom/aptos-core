...
use aptos_config::{
    config::{
        DataStreamingServiceConfig, AptosDataClientConfig, NetworkConfig, NodeConfig,
...
fn setup_aptos_data_client(
    ...
    // Create a new runtime for the aptos data client and spawn the data poller
