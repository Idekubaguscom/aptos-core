...
//   language e2e tests in: aptos/language/e2e-testsuite/src/tests/verify_txn.rs ->
...
//   - aptos/language/move-binary-format/src/unit_tests/deserializer_tests.rs
//   - aptos/language/move-binary-format/tests/serializer_tests.rs
...
//   aptos/language/e2e-testsuite/src/tests/genesis.rs
...
fn test_validate_non_genesis_write_set() {
    ...
    // A WriteSet txn is only valid when sent from the Aptos root account.
