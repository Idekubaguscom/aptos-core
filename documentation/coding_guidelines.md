...
```
aptos$ cargo xclippy --all-targets
```
...
* top-level directories (e.g. `aptos/network`, `aptos/language`)
...
A good example of README.md is `aptos/network/README.md` that describes the networking crate.
