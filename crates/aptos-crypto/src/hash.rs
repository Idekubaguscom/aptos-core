...
//!    creates a collision.
//!
//! Regarding (1), this library makes it easy for Aptos developers to create as
//! many new "hashable" Rust types as needed so that each Rust type hashed and signed
//! in Aptos has a unique meaning, that is, unambiguously captures the intent of a signer.
//!
...
/// A prefix used to begin the salt of every aptos hashable structure. The salt
