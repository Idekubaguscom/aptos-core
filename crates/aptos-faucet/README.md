...
Faucet is a service for creating and funding accounts on Aptos Network by treasury compliance account.
...
* Base URL: `http://faucet.testnet.aptos.com/`
* Path: `/mint`
* Method: POST
...
Decode Example ([source](https://aptos.github.io/client-sdk-python/aptos/testnet.html#aptos.testnet.Faucet)):
...
```bash
curl -X POST http://faucet.testnet.aptos.com/mint\?amount\=1000000\&currency_code\=XUS\&auth_key\=459c77a38803bd53f3adee52703810e3a74fd7c46952c497e75afb0a7932586d\&return_txns\=true
