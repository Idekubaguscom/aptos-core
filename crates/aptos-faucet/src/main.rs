...
#[structopt(
    name = "Aptos Faucet",
    author = "The Aptos Association",
    about = "Aptos Testnet utitlty service for creating test account and minting test coins"
)]
struct Args {
    ...
    #[structopt(short = "s", long, default_value = "https://testnet.aptos.com/")]
