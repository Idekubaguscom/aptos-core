...
//! This crates provides an API for logging in aptos.
...
//! see the [coding guidelines](https://developers.aptos.com/docs/core/coding-guidelines#logging).
//!
...
pub use crate::aptos_logger::{
    AptosLogger, AptosLogger as Logger, AptosLoggerBuilder, Writer, CHANNEL_SIZE,
};
pub use event::Event;
