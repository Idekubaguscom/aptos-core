...
//! constants within the Aptos codebase. This is useful because many different components within
//! Aptos often require access to global constant definitions (e.g., Aptos Safety Rules,
...
pub const DIEM_ROOT_KEY: &str = "aptos_root";
